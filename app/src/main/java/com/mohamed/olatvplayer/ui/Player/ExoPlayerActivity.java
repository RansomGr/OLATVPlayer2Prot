package com.mohamed.olatvplayer.ui.Player;
...
public class ExoPlayerActivity extends AppCompatActivity implements Player.EventListener {
    ...
    public static  String KEY_VIDEO_URI = "";
    ...
    private void setUp() {
       ...
       */
        buildMediaSource(Uri.parse(KEY_VIDEO_URI));
    }
    ...
    private void buildMediaSource(Uri mUri) {
        ...
        //ts link 7otou boucle 1
        // This is the MediaSource representing the media to be played.
      /*  try {
            InputStream i = new URL(mUri.toString()).openStream()   ;
            ...
            while((line = r.readLine())!=null){
                if(line.equals("#EXTM3U")){ //start of m3u8
                    ...
                    MediaSource videoSource = new HlsMediaSource.Factory(dataSourceFactory).createMediaSource(mUri);
                    player.prepare(videoSource);
                    r.close();
                }else { //once found EXTINFO use runner to get the next line which contains the media file, parse duration of the segment
